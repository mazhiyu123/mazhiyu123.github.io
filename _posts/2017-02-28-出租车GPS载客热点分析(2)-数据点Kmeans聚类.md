...
<img src="http://chart.googleapis.com/chart?cht=tx&chl=\Large d = \sqrt{(a_1 - b_1)^2 + (a_2 - b_2)^2 + ... + (a_n - b_n)^2}" style="border:none;">
...
```
<img src="http://chart.googleapis.com/chart?cht=tx&chl=\Large d = (a_1 - b_1)^2 + (a_2 - b_2)^2 + ... + (a_n - b_n)^2" style="border:none;">

<img src="http://chart.googleapis.com/chart?cht=tx&chl=\Large d = a + b + c" style="border:none;">
...
```
<img src="http://chart.googleapis.com/chart?cht=tx&chl=\Large d = |a_1 - b_1| \p |a_2 - b_2| + ... + |a_n - b_n|" style="border:none;">
...
```
<img src="http://chart.googleapis.com/chart?cht=tx&chl=\Large d = 1 - \frac{(a_1b_1 + a_2b_2 + ... + a_nb_n)}{\sqrt{a_1^2 + a_2^2 + ... + a_n^2}\sqrt{b_1^2 + b_2^2 + ... + b_n^2}}" style="border:none;">
...
```
<img src="http://chart.googleapis.com/chart?cht=tx&chl=\Large d = 1 - \frac{(a_1b_1 + a_2b_2 + ... + a_nb_n)}{\sqrt{a_1^2 + a_2^2 + ... + a_n^2}\sqrt{b_1^2 + b_2^2 + ... + b_n^2} - (a_1b_1 + a_2b_2 + ... + a_nb_n)" style="border:none;">
